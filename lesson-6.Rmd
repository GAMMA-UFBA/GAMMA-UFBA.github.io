...
R Markdown ~ â documents can include one or more parameters whose values can be set when you render the report. For example, the [file below](demos/5-parameters.Rmd) uses a `data` parameter that determines which data set to plot.
